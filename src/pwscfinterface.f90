Module PWscfInterface
  ...
  SUBROUTINE Atompaw2PWscf(Grid,AEPot,FC,PAW,ifinput)
     ...
     INTEGER :: i,j,k,l,n,m,io,jo,llmin,llmax,number_of_wfc,nn,ok
...
&       """ columns=""3"" cutoff_radius_index=""",i6,""">")')&
&           TRIM(inputfileline),upfmesh,PAW%l(io),upfirc
...
&       i6,""" columns=""3"">")') PAW%nbase*PAW%nbase*(2*PAW%lmax+1)
      WRITE(1001,'(1p,3e25.17)') (((PAW%multipole(i,j,k),i=1,PAW%nbase),&
      ...
      do io=1,PAW%nbase
         do jo=io,PAW%nbase
            ...
            do l=llmin,llmax,2
               ...
               dum=dum*PAW%multipole(io,jo,l+1)
               arg=dum*(Grid%r**l)
